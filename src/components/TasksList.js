  ...
  return (
    <>
      <Table className="table table-bordered">
        <thead>
          <tr className="text-center" style={{ backgroundColor:'#0d6efd', color: '#fff' }}>
            <th>#</th>
            <th>Title</th>
            <th>Description</th>
            <th>Actions</th>
        ...
        <tbody>
          {
            tasksList && tasksList.map((task,index) => {
              return (
                ...
                <td>
                  <Button style={{boxShadow: '0 4px 8px rgba(18, 41, 240, 5)'}}
                    variant="primary"
                    className="mx-3"
                  ...
                  <Button variant="primary" style={{boxShadow: '0 4px 8px rgba(18, 41, 240, 5)'}}>
